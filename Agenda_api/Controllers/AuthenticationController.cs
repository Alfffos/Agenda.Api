...
namespace AgendaApi.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Autenticar(AutenticationRequestBody authenticationRequestBody) //Enviamos como parámetro la clase que creamos arriba
        {
            // Paso 1: Validamos las credenciales
            var user = await _userRepository.Validate(authenticationRequestBody); //Usamos await para esperar a que la tarea retorne un objeto User
            ...
            claimsForToken.Add(new Claim("given_name", user.Name)); //Accedemos a las propiedades del objeto User
            ...
            ////Paso 1: Validamos las credenciales
            //var user = _userRepository.Validate(authenticationRequestBody); //Lo primero que hacemos es llamar a una función que valide los parámetros que enviamos.
